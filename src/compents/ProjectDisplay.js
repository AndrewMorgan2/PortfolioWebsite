                    ...
                    <div style={{ display: 'inline-flex' }}>
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Device Energy Modelling</h1>
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2"style={{fontSize: "1.5vmax"}}>Billet Sorting System</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Solar Powered Phone Charger</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
                    ...
                    <div style={{ display: 'inline-flex' }}>
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Sound to Light Speaker</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Pinball Machine</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Self-Heating Flask</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
                    ...
                    <div style={{ display: 'inline-flex' }}>
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2" style={{fontSize: "1.5vmax"}}>Binary Clock</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6" style={{fontSize: "1vmax"}}>
