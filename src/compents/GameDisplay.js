                    ...
                    <div style={{ display: 'inline-flex' }}>
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Hexile</h1>
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Arcade Football</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6">
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Space Hex</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6">
                    ...
                    <div style={{ display: 'inline-flex' }}>
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Dino Fight</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6">
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Boy in the Woods</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6">
                        ...
                        <div class="relative flex min-h-screen flex-col justify-center bg-gradient-to-r from-rose-100 to-teal-100" style={{ width: '30%', height: '30%', margin: '1%', display: 'block' }}>
                            <div class="mx-auto flex w-96 flex-col justify-center bg-white rounded-lg shadow-xl shadow-slate-300/60">
                                ...
                                <div class="p-4">
                                    <h1 class="text-2xl font-medium text-slate-600 pb-2">Zombie Game</h1>
                                    <p class="text-sm tracking-tight font-light text-slate-400 leading-6">
