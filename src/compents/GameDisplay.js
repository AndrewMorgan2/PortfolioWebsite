                ...
                <div>
                    <div style={{display: 'inline-flex'}}>
                        ...
                        <div style={{height : '50%', width: '50%', marginLeft: '0.5vmin'}}>
                            <h2 style={{color : '#4483b6', fontSize : "3vmax"}}><b>Dino Fight</b></h2>
                    ...
                    <div style={{display: 'inline-flex'}}>
                        ...
                        <div style={{height : '50%', width: '50%', marginLeft: '0.5vmin'}}>
                            <h2 style={{color : '#4483b6', fontSize : "3vmax"}}><b>Arcade Football</b></h2>
                            <h3 style={{color : 'white', fontSize : "1.5vmax"}}>
                    ...
                    <div style={{display: 'inline-flex'}}>
                        ...
                        <div style={{height : '50%', width: '50%', marginLeft: '0.5vmin'}}>
                            <h2 style={{color : '#4483b6', fontSize : "3vmax"}}><b>Boy in the Woods</b></h2>
                            <h3 style={{color : 'white', fontSize : "1.5vmax"}}>
                    ...
                    <div style={{display: 'inline-flex'}}>
                        ...
                        <div style={{height : '50%', width: '50%', marginLeft: '0.5vmin'}}>
                            <h2 style={{color : '#4483b6', fontSize : "3vmax"}}><b>Zombie Game</b></h2>
                            <h3 style={{color : 'white', fontSize : "1.5vmax"}}>
